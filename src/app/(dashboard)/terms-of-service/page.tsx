...
export const metadata = {
  title: "Điều khoản dịch vụ | Doanh Nghiệp 1 Người",
  description:
    "Điều khoản sử dụng dịch vụ của nền tảng Doanh Nghiệp 1 Người — doanhnghiep1nguoi.online",
};
...
const sections = [
  {
    ...
    title: "1. Giới thiệu",
    content: [
      "Chào mừng bạn đến với doanhnghiep1nguoi.online (\"Nền tảng\") — nền tảng học tập trực tuyến thuộc sở hữu và vận hành bởi Doanh Nghiệp 1 Người (\"chúng tôi\").",
  ...
  },
  {
    ...
    content: [
      "Tất cả nội dung trên Nền tảng (bao gồm nhưng không giới hạn: video, văn bản, hình ảnh, template, mã nguồn, thiết kế) là tài sản trí tuệ của Doanh Nghiệp 1 Người hoặc đối tác được uỷ quyền.",
    ],
    list: [
