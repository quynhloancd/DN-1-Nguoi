...
export const metadata = {
  title: "Chính sách bảo mật | Doanh Nghiệp 1 Người",
  description:
    "Chính sách bảo mật và bảo vệ dữ liệu cá nhân của nền tảng Doanh Nghiệp 1 Người — doanhnghiep1nguoi.online",
};
...
const sections = [
  {
    ...
    content: [
      "Khi bạn sử dụng nền tảng doanhnghiep1nguoi.online, chúng tôi có thể thu thập các loại thông tin sau:",
    ],
    list: [
      "Họ và tên đầy đủ",
      "Địa chỉ email",
