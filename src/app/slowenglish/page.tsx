...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://doanhnghiep1nguoi.online/slowenglish",
  },
  openGraph: {
    ...
    type: "website",
    url: "https://doanhnghiep1nguoi.online/slowenglish",
    images: [
      {
        url: "https://doanhnghiep1nguoi.online/images/slowenglish/banner-ultra.png",
        width: 1200,
        height: 630,
