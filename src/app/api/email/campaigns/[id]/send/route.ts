...
// Stub SES client type to preserve existing function signatures
...
function createSESClient(): SESv2Client {
  // No-op: emails go through Resend now (see sendEmailWithParams). Stub returned for callsite compatibility.
