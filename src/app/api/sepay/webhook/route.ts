  ...
  try {
    ...
    try {
      ...
      trackPurchase({
        ...
        sourceUrl: products?.slug ? `https://${process.env.NEXT_PUBLIC_SITE_DOMAIN || "doanhnghiep1nguoi.online"}/courses/${products.slug as string}` : `https://${process.env.NEXT_PUBLIC_SITE_DOMAIN || "doanhnghiep1nguoi.online"}`,
      }).catch(() => {});
    } catch {
