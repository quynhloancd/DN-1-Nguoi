...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://doanhnghiep1nguoi.online/updateveo3.1",
  },
  openGraph: {
    ...
    type: "website",
    url: "https://doanhnghiep1nguoi.online/updateveo3.1",
    images: [
      {
        url: "https://doanhnghiep1nguoi.online/images/updateveo31/banner.png",
        width: 1200,
        height: 630,
