...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://doanhnghiep1nguoi.online/weballinone",
  },
  openGraph: {
    title:
    ...
    type: "website",
    url: "https://doanhnghiep1nguoi.online/weballinone",
    images: [
      {
        url: "https://doanhnghiep1nguoi.online/images/weballinone/banner.png",
        width: 1200,
        height: 630,
