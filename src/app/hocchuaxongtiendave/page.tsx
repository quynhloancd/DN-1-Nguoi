...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://doanhnghiep1nguoi.online/hocchuaxongtiendave",
  },
  openGraph: {
    title: "Học Chưa Xong - Tiền Đã Về | Tự Xây Hệ Thống Bán Sản Phẩm Số Bằng AI Agent",
    description:
    ...
    type: "website",
    url: "https://doanhnghiep1nguoi.online/hocchuaxongtiendave",
    images: [
      {
        url: "https://doanhnghiep1nguoi.online/images/hocchuaxongtiendave/banner.jpeg",
        width: 1024,
        height: 576,
