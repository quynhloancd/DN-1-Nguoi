...
export default function SendEmailNode({ data }: { data: any }) {
  return (
    <div className="px-4 py-3 rounded-xl border border-[#3b82f6] bg-white min-w-[180px] shadow-lg shadow-blue-900/20">
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <div className="text-xs text-[#1B2A4A] font-medium truncate max-w-[140px]">
