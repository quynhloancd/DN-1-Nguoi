...
export default function AddTagNode({ data }: { data: any }) {
  return (
    <div className="px-4 py-3 rounded-xl border border-[#8b5cf6] bg-white min-w-[180px] shadow-lg shadow-purple-900/20">
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <div className="text-xs text-[#1B2A4A] font-medium">{data.tagName || "Chưa chọn tag"}</div>
        </div>
      </div>
