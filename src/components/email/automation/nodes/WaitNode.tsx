...
export default function WaitNode({ data }: { data: any }) {
  ...
  return (
    <div className="px-4 py-3 rounded-xl border border-[#f59e0b] bg-white min-w-[180px] shadow-lg shadow-amber-900/20">
      ...
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <div className="text-xs text-[#1B2A4A] font-medium">{label}</div>
        </div>
      </div>
