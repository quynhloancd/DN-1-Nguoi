 ...
 * Thương hiệu Doanh Nghiệp 1 Người — thay cho footer KOHADA của template gốc.
 */
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="flex items-center gap-3">
              {socials.map(({ href, Icon, label }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-9 h-9 rounded-lg flex items-center justify-center bg-white/5 hover:bg-[#F97316] hover:text-white text-gray-300 transition-colors"
                >
                  <Icon size={17} />
                </a>
              ))}
          ...
          <div>
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-white text-sm transition-colors"
